  ...
  return (
    <>
      <tr>
        <td>
          <input
            value={props.input_object.id}
            readonly="readonly"
            
          />
        </td>
        <td>
          <input value={props.input_object.name} onChange={cb_onChange}/>
        </td>
        <td>
          <input value={props.input_object.quantity} onChange={cb_onChange}/>
        </td>
        <td>
          <input value={props.input_object.description} onChange={cb_onChange}/>
        </td>
        <td>
          <input
        ...
        <td>
          <input value={props.input_object.sub_category}onChange={cb_onChange} />
        </td>
        <td>
          <input
